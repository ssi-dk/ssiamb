...
class TestProvenanceRecordCreation:
    ...
    def test_create_provenance_with_inputs(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=".fastq") as r1_file, \
    ...
    def test_create_provenance_with_warnings(self):
        ...
        warnings = [
            ...
            QCWarning("callable_bases", 500_000, 1_000_000, "Low callable bases: 500,000 < 1,000,000")
        ]
        ...
        assert "callable_bases: Low callable bases: 500,000 < 1,000,000" in record.warnings
...
class TestProvenanceJSONOutput:
    ...
    def test_write_provenance_json_single_record(self):
        ...
        record = ProvenanceRecord(
            ...
            extras_emitted={"vcf": False, "bed": False, "matrix": False, "per_contig": False},
            warnings=[]
        )
    ...
    def test_json_output_format_validation(self):
        ...
        record = ProvenanceRecord(
            ...
            species_selection={"bracken_species": "Listeria monocytogenes", "bracken_frac": 0.85},
            ...
            grid_cell_used={"depth": 10, "maf_bin": 10},
            extras_emitted={"vcf": True, "bed": False, "matrix": True, "per_contig": False},
        ...
        try:
            ...
            required_fields = [
                "tool_version", "python_version", "started_at", "finished_at",
                "runtime_sec", "threads", "sample", "mode", "mapper", "caller",
                "thresholds", "denom_policy", "depth_tool", "inputs",
                "reference_info", "grid_cell_used", "extras_emitted"
            ]
