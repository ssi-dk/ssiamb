...
class TestCallerToolChecks:
    ...
    def test_bbtools_tools_available(self, mock_which):
        ...
        mock_which.side_effect = lambda tool: f"/usr/bin/{tool}" if tool in ["pileup.sh", "callvariants.sh"] else None
    ...
    def test_bcftools_available(self, mock_which):
        ...
        mock_which.side_effect = lambda tool: "/usr/bin/bcftools" if tool == "bcftools" else None
...
class TestCallVariants:
    ...
    def test_call_variants_bbtools(self, mock_exists, mock_bbtools, mock_check_tools, tmp_path):
