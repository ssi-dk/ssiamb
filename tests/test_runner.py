...
class TestRunPlanCreation:
    ...
    def test_create_run_plan_self_mode_minimal(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch('src.ssiamb.runner.infer_sample_name', return_value="test_sample"), \
                 patch('src.ssiamb.runner.validate_sample_name', return_value="test_sample"):
    ...
    def test_create_run_plan_sample_validation_error(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch('src.ssiamb.runner.validate_sample_name', side_effect=SampleNameError("Invalid sample name")):
