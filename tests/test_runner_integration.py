...
class TestRefAccessionExtraction:
    ...
    def test_extract_ref_accession_success(self):
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.fasta', delete=False) as tmp_file:
            tmp_file.write(">NC_000913.3 Escherichia coli str. K-12 substr. MG1655, complete genome\n")
    ...
    def test_extract_ref_accession_genbank_format(self):
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.fasta', delete=False) as tmp_file:
            tmp_file.write(">gi|49175990|ref|NC_000913.2| Escherichia coli str. K-12 substr. MG1655 chromosome, complete genome\n")
            tmp_file.write("ACGTACGTACGT\n")
            tmp_file.flush()
